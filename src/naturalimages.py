...
if __name__=='__main__':
	...
	x_train = ['../natural-images/natural_images/person/person_0{}.jpg'.format(x) for x in range(100,985)]
	x_test = ['../natural-images/natural_images/person/person_00{}.jpg'.format(x) for x in range(99)]
	...
	model.fit_generator(generator(x_train), steps_per_epoch=stepsOf(x_train), epochs=10, shuffle=True,
